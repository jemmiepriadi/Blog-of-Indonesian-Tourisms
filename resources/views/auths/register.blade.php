                                    ...
                                    <div class="card-body">
                                        ...
                                        {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="name" id="inputName" type="text" placeholder="Enter Name" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="phone" id="inputPassword" type="text" placeholder="Enter Number" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary" name="login" href="index.html">Submit</button>
                                            </div>
                                        </form>
                                    </div>
